<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            <?php echo "<b>$item->company_name</b> Firması Düzenleniyor"; ?>
        </h4>
    </div><!-- END column -->
    ...
    <div class="col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <form action="<?php echo base_url("company/update/$item->id");?>" method="post">
                    <div class="form-group">
                        <label>Firma Adı</label>
                        <input type="text" class="form-control" placeholder="Firma Adı" name="company_name" value="<?php echo $item->company_name; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="YDS Kullanıcı Adı" name="yds_user" value="<?php echo $item->yds_user; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="YDS Kullanıcı Şifre" name="yds_pass" value="<?php echo $item->yds_pass; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Firma Adresi" name="company_address" value="<?php echo $item->company_address; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="YDK Dosya No" name="ydk_file_no" value="<?php echo $item->ydk_file_no; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Faaliyet İli" name="activity_city" value="<?php echo $item->activity_city; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Yetkili Kişi" name="authorized_person" value="<?php echo $item->authorized_person; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Yetkili Kişi Ünvan" name="authorized_person_title" value="<?php echo $item->authorized_person_title; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Yetkili Kişi TC No" name="authorized_person_tcno" value="<?php echo $item->authorized_person_tcno; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        <label>Telefon</label>
                        <input type="text" class="form-control" placeholder="Telefon" name="phone" value="<?php echo $item->phone; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Web Adresi" name="website" value="<?php echo $item->website; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="form-group">
                        <label>E-posta</label>
                        <input type="email" class="form-control" placeholder="E-posta" name="email" value="<?php echo $item->email; ?>">
                        <?php if (isset($form_error)) { ?>
