            ...
            <ul class="app-menu">
                ...
                <li>
                    <a href="javascript:void(0)">
                        ...
                        <span class="menu-text">Şantiyeler</span>
                    </a>
                </li>
                ...
                <li class="has-submenu">
                    <a href="javascript:void(0)" class="submenu-toggle">
                        ...
                        <span class="menu-text">Yds</span>
                        <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
                    </a>
                    <ul class="submenu">
                        <li><a href="../default/index.html"><span class="menu-text">Güncel Yibf Listesi</span></a></li>
                        <li><a href="../topbar/index.html"><span class="menu-text">Ruhsat Bekleyen Yibf Listesi</span></a></li>
                        <li><a href="../topbar/index.html"><span class="menu-text">Yds Giriş</span></a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:void(0)">
                        ...
                        <span class="menu-text">Yds Foto</span>
                    </a>
                </li>
